...
namespace basic_chaos_engine
{
    ...
    inline float basic_audio_openal::source_get_volume(type::SourceID source_id)
    {
        float _volume = 0;
        alGetSourcef(source_id, AL_GAIN, &_volume);
        if ((_last_error = alGetError()) != AL_NO_ERROR) return 0;
        return _volume;
    }
    ...
    inline bool basic_audio_openal::source_set_volume(type::SourceID source_id, float volume)
    {
